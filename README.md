...
```
That creates a file called `00_user_files_select.sql` in user_files with select statements for the files in that directory.  The file has more then what is show above, that is just to give an indication that it actually did something.
